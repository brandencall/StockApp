...
begin
    ...
    DistinctStocks AS (
        ...
        GROUP BY
            ...
            s.Name
        HAVING
            COUNT(DISTINCT fa.Title) = 10 -- Number of fa.Title values in the IN list minus MarketCapitalization
    )
    ...
    SELECT
        ...
        ds.Ticker,
        ff.FiscalYear,
        MAX(CASE WHEN fa.Title = 'MarketCapitalization' THEN m.CurrencyValue END) AS MarketCapitalization,
        MAX(CASE WHEN fa.Title = 'Assets' THEN cv.Value END) AS Assets,
        MAX(CASE WHEN fa.Title = 'NetCashProvidedByUsedInFinancingActivities' THEN cv.Value END) AS NetCashProvidedByUsedInFinancingActivities,
        MAX(CASE WHEN fa.Title = 'NetCashProvidedByUsedInOperatingActivities' THEN cv.Value END) AS NetCashProvidedByUsedInOperatingActivities,
        ...
        MAX(CASE WHEN fa.Title = 'NetCashProvidedByUsedInInvestingActivities' THEN cv.Value END) AS NetCashProvidedByUsedInInvestingActivities,
